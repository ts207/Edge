...
def test_engine_smoke_accepts_executable_strategy_spec(mock_data_root):
    ...
    result = run_engine(
        ...
        params_by_strategy={"dsl_interpreter_v1__smoke_exec": {"executable_strategy_spec": executable.model_dump()}},
        params={},
        cost_bps=5.0,
        start_ts=pd.Timestamp("2024-01-01", tz="UTC"),
        end_ts=pd.Timestamp("2024-01-02", tz="UTC"),
...
def test_engine_smoke_accepts_allocation_spec(mock_data_root):
    ...
    allocation_spec = AllocationSpec.model_validate(
        {
            ...
            "allocation_policy": {
                "symbol_scope": {"mode": "single_symbol", "symbols": ["BTCUSDT"], "candidate_symbol": "BTCUSDT"},
                "constraints": {"allocator_mode": "deterministic_optimizer", "strategy_risk_budgets": {"dsl_interpreter_v1__smoke_alloc": 1.0}},
            },
        }
    )
    ...
    result = run_engine(
        ...
        params_by_strategy={"dsl_interpreter_v1__smoke_alloc": {"executable_strategy_spec": executable.model_dump(), "allocation_spec": allocation_spec.model_dump()}},
        params={},
        cost_bps=5.0,
        start_ts=pd.Timestamp("2024-01-01", tz="UTC"),
        end_ts=pd.Timestamp("2024-01-02", tz="UTC"),
