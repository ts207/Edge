...
from project.reliability.contracts import validate_promotion_audit, validate_evidence_bundle_summary, validate_promotion_decisions
...
def test_validate_promotion_artifacts_schemas():
    audit = pd.DataFrame({
        ...
        'gate_promo_statistical': ['pass'], 'gate_promo_stability': ['pass'], 'gate_promo_cost_survival': ['pass'], 'gate_promo_negative_control': ['pass'],
    })
