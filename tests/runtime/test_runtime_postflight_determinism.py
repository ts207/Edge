...
def test_runtime_postflight_surfaces_determinism_and_oms_fields(tmp_path):
    ...
    pd.DataFrame([
        {'event_id': '1', 'event_type': 'order_submit', 'timestamp': '2024-01-01T00:00:00Z', 'detected_ts': '2024-01-01T00:00:00Z', 'symbol': 'BTCUSDT', 'source_seq': 1, 'order_id': 'o1', 'provenance': 'execution'},
        {'event_id': '2', 'event_type': 'order_fill', 'timestamp': '2024-01-01T00:00:01Z', 'detected_ts': '2024-01-01T00:00:01Z', 'symbol': 'BTCUSDT', 'source_seq': 2, 'order_id': 'o1', 'provenance': 'execution'},
