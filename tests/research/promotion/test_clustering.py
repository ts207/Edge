...
def test_cluster_identical_behavior():
    ...
    df = pd.DataFrame([
        {"candidate_id": "c1", "event_type": "E1", "horizon": "15m", "template_verb": "V1", "selection_score": 10.0},
        {"candidate_id": "c2", "event_type": "E1", "horizon": "15m", "template_verb": "V1", "selection_score": 5.0},
        {"candidate_id": "c3", "event_type": "E2", "horizon": "60m", "template_verb": "V2", "selection_score": 8.0},
    ])
...
def test_cluster_delay_correlation():
    ...
    df = pd.DataFrame([
        {
            "candidate_id": "c1", "event_type": "E1", "horizon": "5m", 
            "delay_expectancy_map": {"0": 1.0, "1": 0.5, "2": 0.2}, 
            "selection_score": 1.0
        },
        {
            "candidate_id": "c2", "event_type": "E2", "horizon": "15m", 
            "delay_expectancy_map": {"0": 2.0, "1": 1.0, "2": 0.4},
            "selection_score": 2.0
        },
        {
            "candidate_id": "c3", "event_type": "E3", "horizon": "30m", 
...
def test_build_cluster_summary():
    ...
    df = pd.DataFrame([
        {"candidate_id": "c1", "cluster_id": "clus1", "selection_score": 10.0, "event_type": "E1"},
        {"candidate_id": "c2", "cluster_id": "clus1", "selection_score": 50.0, "event_type": "E1"}, # better
        {"candidate_id": "c3", "cluster_id": "clus2", "selection_score": 8.0, "event_type": "E2"},
    ])
