...
def test_promotion_decisions_handles_string_gates():
    ...
    assert result['promotion_audit']['gate_promo_statistical'] in ('pass', 'fail', 'missing_evidence')
    assert result['promotion_audit']['gate_promo_microstructure'] in ('pass', 'fail', 'missing_evidence')
