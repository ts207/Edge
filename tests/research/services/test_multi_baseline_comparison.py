...
def test_certify_with_multiple_priors():
    ...
    priors = [
        {
            "matrix_id": "test_matrix",
            "slices": [{"benchmark_id": "s1", "benchmark_status": "informative", "hard_evaluated_rows": 110}]
        },
        {
            "matrix_id": "test_matrix",
            "slices": [{"benchmark_id": "s1", "benchmark_status": "informative", "hard_evaluated_rows": 120}]
        }
    ]
