...
- Details:
  - `maturity_counts`: `{'standard': 61, 'production': 6, 'specialized': 3}`
  - `evidence_tier_counts`: `{'hybrid': 26, 'statistical': 9, 'inferred_cross_asset': 7, 'direct': 20, 'contextual': 4, 'sequence_confirmed': 4}`
  - `issues`: `[]`
...
- Status: `passed`
- Summary:
  - `contracts_with_overlap_notes`: `70`
  - `avg_expected_overlap_entries`: `1.129`
  - `direct_proxy_group_count`: `1`
  - `ontology_collision_group_count`: `0`

- Details:
  - `direct_proxy_groups`: `{'LIQUIDITY_STRESS': ['LIQUIDITY_STRESS_DIRECT', 'LIQUIDITY_STRESS_PROXY']}`
  - `ontology_collisions`: `{}`
...
- Summary:
  ...
  - `contracts_with_disabled_regimes`: `70`
  - `avg_disabled_regime_entries`: `1.071`
...
- Status: `passed`
- Summary:
  - `events_with_required_features`: `70`
  - `unique_required_feature_count`: `9`
  - `unique_required_column_count`: `19`
  - `events_missing_required_columns`: `0`

- Details:
  - `top_required_features`: `{'timestamp': 70, 'close': 3, 'pair_close': 1, 'close_spot': 1, 'close_perp': 1, 'funding_rate': 1, 'high': 1, 'low': 1, 'volume': 1}`
  - `top_required_columns`: `{'timestamp': 70, 'close': 47, 'rv_96': 21, 'high': 17, 'low': 17, 'oi_delta_1h': 6, 'range_96': 5, 'range_med_2880': 5, 'volume': 5, 'liquidation_notional': 5, 'close_perp': 4, 'close_spot': 4, 'oi_notional': 4, 'funding_abs_pct': 3, 'funding_abs': 3}`
