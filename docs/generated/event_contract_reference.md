...
- Family: canonical=`LIQUIDATION_CASCADE` | legacy=`POSITIONING_EXTREMES`
...
- Detector: `unwired` | enabled=`None` | default_executable=`True`
...
- Detector: `unwired` | enabled=`None` | default_executable=`True`
- Family: canonical=`POSITIONING_UNWIND_DELEVERAGING` | legacy=`FORCED_FLOW_AND_EXHAUSTION`
