...
from project.pipelines.research.bridge_evaluate_phase2 import _load_candidates, _select_bridge_candidates
...
def test_bridge_select_candidates_candidate_mask_all_bypasses_mode_filters():
    df = pd.DataFrame(
        [
            {"candidate_id": "c1", "gate_phase2_research": False, "gate_phase2_final": False, "is_discovery": False},
            {"candidate_id": "c2", "gate_phase2_research": True, "gate_phase2_final": False, "is_discovery": False},
        ]
    )
...
def test_bridge_select_candidates_candidate_mask_final_forces_strict_final_gate():
    df = pd.DataFrame(
        [
            {"candidate_id": "c1", "gate_phase2_research": True, "gate_phase2_final": True, "is_discovery": False},
            {"candidate_id": "c2", "gate_phase2_research": False, "gate_phase2_final": True, "is_discovery": True},
            {"candidate_id": "c3", "gate_phase2_research": True, "gate_phase2_final": False, "is_discovery": True},
        ]
    )
