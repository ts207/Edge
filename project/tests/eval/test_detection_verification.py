...
def test_direct_vs_proxy_liquidity_detection():
    ...
    df_direct = pd.DataFrame({
        ...
        "spread_bps": 2.0, "depth_usd": 1000000.0,
    })
...
from project.eval.detection_verification_suite import DetectionVerificationSuite, run_detection_verification
