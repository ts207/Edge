...
from project.research.walkforward import generate_walkforward_windows, evaluate_walkforward_stability, WindowResult
...
def test_walkforward_windows():
    ...
    windows = generate_walkforward_windows(idx, train_size_bars=40, test_size_bars=10, step_size_bars=10)
