...
def test_hypothesis_id_determinism():
    ...
    # None vs empty dict
    h1 = HypothesisSpec(
        trigger=t, direction="long", horizon="15m", template_id="test", context=None
    )
...
def test_hypothesis_context_order_determinism():
    ...
    h1 = HypothesisSpec(
        trigger=t, direction="long", horizon="15m", template_id="test", context={"b": "2", "a": "1"}
    )
    h2 = HypothesisSpec(
        trigger=t, direction="long", horizon="15m", template_id="test", context={"a": "1", "b": "2"}
    )
