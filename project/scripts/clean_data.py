...
def main() -> int:
    ...
    parser.add_argument("--days", type=int, default=14, help="Delete run artifacts older than this many days")
    parser.add_argument("--dry_run", action="store_true", help="Print what would be deleted without deleting")
