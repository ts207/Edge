...
from project.reliability.schemas import ENGINE_MANIFEST_SCHEMA, STAGE_MANIFEST_SCHEMA, ManifestSchemaSpec
...
def validate_manifest_artifacts_exist(manifest_or_path: Dict[str, Any] | Path | str) -> Dict[str, Any]:
...
def summarize_manifest_environment(*, git_sha: str, python_version: str, storage_mode: str, smoke_dataset_version: str, config_hash: str) -> Dict[str, Any]:
    return {
        'git_sha': str(git_sha),
