...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build a deduplicated shadow playbook from exported research survivors.")
    ...
    adjacent_survivorship = Path(args.adjacent_survivorship_report_path) if args.adjacent_survivorship_report_path else None
