...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Ingest Binance spot OHLCV 5m from archives")
    ...
    manifest = start_manifest("ingest_binance_spot_ohlcv_5m", run_id, params, inputs, outputs)
