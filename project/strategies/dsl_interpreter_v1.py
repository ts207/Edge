...
from project.strategies.dsl_runtime.interpreter import DslInterpreterV1 as _InterpreterImpl
...
class DslInterpreterV1:
    ...
    Logic is decomposed into project.strategy.dsl.* and project.strategies.dsl_runtime.*.
    """
...
def generate_positions_numba(
    ...
    from project.strategies.dsl_runtime.interpreter import (
