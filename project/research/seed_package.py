...
DEFAULT_PACKAGE_RUN_ID = INTERNAL_MAINTENANCE_PACKAGE_RUN_ID
    ...
    *,
    ...
    thesis = PromotedThesis(
        ...
        **_maintenance_fields(promotion_class=promotion_class, source_type=source_type, bundles=bundles),
        ...
        required_context=(dict(thesis_def.required_context) if thesis_def is not None else {}),
        supportive_context={
...
def package_seed_promoted_theses(
    *,
    ...
    overlap_payload = write_thesis_overlap_artifacts(
        theses,
        docs_root,
        source_run_id=package_run_id,
    ...
    metadata = build_summary_metadata(
        schema_version="seed_thesis_packaging_summary_v1",
        artifact_root=docs_root,
        source_run_id=package_run_id,
        workspace_root=workspace_root,
    ...
    summary_lines.extend(metadata_markdown_lines(metadata))
